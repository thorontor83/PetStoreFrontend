...
public class PetConfig {
    ...
    CommandLineRunner commandLineRunner2(PetRepository petRepository){
        return args -> {
            ...
            PetEntity petEntity5 = new PetEntity("Sphynx","photo5", 2L, "Cat","Medium Aggressive Furless", PetStatus.SOLD);
            PetEntity petEntity6 = new PetEntity("Hummingbird","photo6", 4L, "Bird","Small Delicate", PetStatus.PENDING);
            PetEntity petEntity7 = new PetEntity("Bulldog","photo7",1L,"Dog","Medium Friendly Lazy", PetStatus.AVAILABLE);
            PetEntity petEntity8 = new PetEntity("Chihuahua","photo8",1L,"Dog","Small Aggressive", PetStatus.AVAILABLE);
            PetEntity petEntity9 = new PetEntity("Stray","photo9",2L,"Cat","Medium Independent", PetStatus.PENDING);
            PetEntity petEntity10 = new PetEntity("Sparrow","photo10",4L,"Bird","Small Singer", PetStatus.AVAILABLE);
            PetEntity petEntity11 = new PetEntity("Mastiff","photo11",1L,"Dog","Large Friendly", PetStatus.SOLD);
            PetEntity petEntity12 = new PetEntity("Corgie","photo12",1L,"Dog","Small Friendly Smart", PetStatus.AVAILABLE);
